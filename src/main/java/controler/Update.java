...
//		super.doGet(req, resp);
		...
		String kannada1=	req.getParameter("kan");
		int kannada=Integer.parseInt(kannada1);
		String engish1=	req.getParameter("eng");
		int english=Integer.parseInt(engish1);
		String hindi1=	req.getParameter("hind");
...
//		System.out.println("Result"+" "+Result);
		...
		String msg=dao.update(Usn,dto);
		resp.getWriter().print(msg);
		
		List<StudentMarks>std=dao.fetchAll();
		req.setAttribute("fetchall", std);
		RequestDispatcher rd1=req.getRequestDispatcher("fetchAll.jsp");
